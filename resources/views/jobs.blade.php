...
<head>
    ...
    <link rel="apple-touch-icon" sizes="144x144" href="{{asset('jobs/images/ico/apple-touch-icon-144-precomposed.png')}}">
    <link rel="apple-touch-icon" sizes="114x114" href="{{asset('jobs/images/ico/apple-touch-icon-114-precomposed.png')}}">
    ...
    <header id="header" class="clearfix">
        ...
        <nav class="navbar navbar-default navbar-expand-lg">
            <div class="container">
                ...
                <a class="navbar-brand" href="index-2.html"><img class="img-fluid" src="{{asset('jobs/logo.png')}}" alt="Logo"></a>
        ...
        <div class="container">
                ...
                <ul class="category-list">
                    <li class="category-item">
                        <a href="job-list.html">
                            <div class="category-icon"><img src="{{asset('jobs/images/icon/1.png')}}" alt="images" class="img-fluid"></div>
                    ...
                    <li class="category-item">
                        <a href="job-list.html">
                            <div class="category-icon"><img src="{{asset('jobs/images/icon/2.png')}}" alt="images" class="img-fluid"></div>
                    ...
                    <li class="category-item">
                        <a href="job-list.html">
                            <div class="category-icon"><img src="{{asset('jobs/images/icon/3.png')}}" alt="images" class="img-fluid"></div>
                    ...
                    <li class="category-item">
                        <a href="job-list.html">
                            <div class="category-icon"><img src="{{asset('jobs/images/icon/4.png')}}" alt="images" class="img-fluid"></div>
                    ...
                    <li class="category-item">
                        <a href="job-list.html">
                            <div class="category-icon"><img src="{{asset('jobs/images/icon/5.png')}}" alt="images" class="img-fluid"></div>
                    ...
                    <li class="category-item">
                        <a href="job-list.html">
                            <div class="category-icon"><img src="{{asset('jobs/images/icon/6.png')}}" alt="images" class="img-fluid"></div>
                    ...
                    <li class="category-item">
                        <a href="job-list.html">
                            <div class="category-icon"><img src="{{asset('jobs/images/icon/7.png')}}" alt="images" class="img-fluid"></div>
                    ...
                    <li class="category-item">
                        <a href="job-list.html">
                            <div class="category-icon"><img src="{{asset('jobs/images/icon/8.png')}}" alt="images" class="img-fluid"></div>
                    ...
                    <li class="category-item">
                        <a href="job-list.html">
                            <div class="category-icon"><img src="{{asset('jobs/images/icon/9.png')}}" alt="images" class="img-fluid"></div>
                    ...
                    <li class="category-item">
                        <a href="job-list.html">
                            <div class="category-icon"><img src="{{asset('jobs/images/icon/10.png')}}" alt="images" class="img-fluid"></div>
                    ...
                    <li class="category-item">
                        <a href="job-list.html">
                            <div class="category-icon"><img src="{{asset('jobs/images/icon/11.png')}}" alt="images" class="img-fluid"></div>
                    ...
                    <li class="category-item">
                        <a href="job-list.html">
                            <div class="category-icon"><img src="{{asset('jobs/images/icon/12.png')}}" alt="images" class="img-fluid"></div>
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="hot-jobs">
                            ...
                            <div class="item-info">
                                <div class="item-image-box">
                                    <div class="item-image">
                                        <a href="job-details.html"><img src="{{asset('jobs/images/job/3.png')}}" alt="Image" class="img-fluid"></a>
                                    </div><!-- item-image -->
                                </div>
                        ...
                        <div class="job-ad-item">
                            <div class="item-info">
                                <div class="item-image-box">
                                    <div class="item-image">
                                        <a href="job-details.html"><img src="{{asset('jobs/images/job/1.png')}}" alt="Image" class="img-fluid"></a>
                                    </div><!-- item-image -->
                                </div>
                        ...
                        <div class="job-ad-item">
                            <div class="item-info">
                                <div class="item-image-box">
                                    <div class="item-image">
                                        <a href="job-details.html"><img src="{{asset('jobs/images/job/2.png')}}" alt="Image" class="img-fluid"></a>
                                    </div><!-- item-image -->
                                </div>
                        ...
                        <div class="job-ad-item">
                            <div class="item-info">
                                <div class="item-image-box">
                                    <div class="item-image">
                                        <a href="job-details.html"><img src="{{asset('jobs/images/job/4.png')}}" alt="Image" class="img-fluid"></a>
                                    </div><!-- item-image -->
                                </div>
            ...
            <div class="section workshop-traning">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="workshop">
                            <img src="{{asset('jobs/images/job/5.png')}}" alt="Image" class="img-fluid">
                    ...
                    <div class="col-md-6">
                        <div class="workshop">
                            <img src="{{asset('jobs/images/job/6.png')}}" alt="Image" class="img-fluid">
