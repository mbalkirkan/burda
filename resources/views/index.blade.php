    ...
    <div class="container">
        ...
        <div class="header-navigation">
            <ul>
                ...
                <li><a href="http://www.keenthemes.com/preview/metronic/theme/templates/admin/ecommerce_index.html"
...
<div class="main">
    <div class="container">
                    ...
                    @foreach($new_products as $item)
                        <div>
                            <div class="product-item">
                                ...
                                <a href="javascript:;" class="btn btn-default add2cart">{{$item->product_categories_name}}</a>
        ...
        <div class="sidebar-products clearfix col-md-3 col-sm-4">
            <h2>Bestsellers</h2>
            <div class="item">
                    ...
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img src="assets/frontend/pages/img/index-sliders/slide1.jpg" class="img-responsive"
                                     alt="Berry Lace Dress">
                            </div>
                            <div class="item">
                                <img src="assets/frontend/pages/img/index-sliders/slide2.jpg" class="img-responsive"
                                     alt="Berry Lace Dress">
                            </div>
                            <div class="item">
                                <img src="assets/frontend/pages/img/index-sliders/slide3.jpg" class="img-responsive"
                                     alt="Berry Lace Dress">
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                <ul class="list-unstyled list-inline pull-right">
                    <li><img src="assets/frontend/layout/img/payments/western-union.jpg" alt="We accept Western Union"
                             title="We accept Western Union"></li>
                    <li><img src="assets/frontend/layout/img/payments/american-express.jpg"
                             alt="We accept American Express" title="We accept American Express"></li>
                    <li><img src="assets/frontend/layout/img/payments/MasterCard.jpg" alt="We accept MasterCard"
                             title="We accept MasterCard"></li>
                    <li><img src="assets/frontend/layout/img/payments/PayPal.jpg" alt="We accept PayPal"
                             title="We accept PayPal"></li>
                    <li><img src="assets/frontend/layout/img/payments/visa.jpg" alt="We accept Visa"
