            ...
            <div class="sidebar col-md-3 col-sm-4">
                <ul class="list-group margin-bottom-25 sidebar-menu">
                    @foreach($categories as $item)
                        <li @if($item->name==$category_name) class="active list-group-item clearfix" @else  class="list-group-item clearfix" @endif ><a href="{{route('category',['category'=>$item->slug])}}"><i
